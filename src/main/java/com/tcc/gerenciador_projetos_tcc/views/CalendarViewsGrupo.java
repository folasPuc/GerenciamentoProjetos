...
@Route("calendar-grupo")
public class CalendarViewsGrupo extends VerticalLayout implements HasUrlParameter<String> {
        ...
        Button saveButton = new Button(newInstance ? "Criar" : "Salvar", e -> {
            try {
                ...
                if (binder.validate().isOk()) {
                    ...
                    calendarEvent.setOwnerId(groupId);
    ...
    private List<Entry> loadInitialEntries(int id) {
        ...
        List<CalendarEvent> calendarEntries = calendarEventService.getEventsForGroup(id);
